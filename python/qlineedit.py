...
class MyApp(QWidget):
	...
	def initUI(self):
		...
		self.input_mask_le.setPlaceholderText('Placeholer Text')
		...
		self.access_le.setPlaceholderText('Placeholer Text')
	...
	def input_mask_changed(self,index):
		if index == 0:
			...
			self.input_mask_le.setInputMask('>AAAA-AAAA-AAAA-AAAA;#')
			
	def access_chcanged(self, index):
		if index == 0:
